...
**Password Analyzer** — evaluate the strength of any password and gives tips to improve it.
...
✅ Generates secure random passwords (uppercase, lowercase, digits, symbols)

✅ Saves generated passwords to a .txt file for later use

✅ Batch-analyzes previously saved passwords from a file
